...
- - What is your favorite game?
  ...
  - I mostly play minecraft, but also play Terraria
- - Do you like board games?
  - Yes, I very much like them
  - Yes, Have you played monopoly?
- - do you drink
...
- - What is the United States of America
  - the most powerful and civil country in the history of earth
- - Why is The United States of America so civil?
  - the reason is becuase it is a country that can fix its own issues
  - it was the country that drove slavery out 
  - it was the country that fought for freedom for all
- - why is the united states so powerful?
  - the reason it the most powerful is because it has a free market
  - a free market drives competition to make better and cheaper proucts 
  - also, another reason why America is powerful is the freedom that people were given by god
  - the citizens want to protect their god-given rights and make others realize their freedoms
- - What country created the world as we know it?
...
- - what is the illuminati
  - a secret organization believed by some to be in control of all governments through
...
- - what is avogadro s number
  - it is the number of molecules per mole.  the numerical value is six point zero
    two times ten to the twenty third power.
- - what is ultrasound
...
- - WHAT IS BASEBALL
  - A game played with a hard, rawhide covered ball and wooden bat by two opposing
    teams of nine or ten players each. It is played on a field with four bases forming
    a diamond-shaped circuit.
- - WHAT IS SOCCER
  - A game played with a round ball by two teams of eleven players on a field with
...
- - What year was President John F. Kennedy assassinated?
  - '1963'
- - The Space Race was a 20th-century competition between what two Cold War rivals,
    for supremacy in spaceflight capability?
  - The Soviet Union and the United States.
- - What was the name of the first artificial Earth satellite?
  - Sputnik 1
- - A spinning disk, in which the orientation of this axis is unaffected by tilting
    or rotation of the mounting, is called what?
  - A gyroscope.
- - The Hubble Space Telescope, launched into low Earth orbit in 1990, is named after
...
- - The Celtic Shelf, the seabed under the Celtic Sea is a part of the continental
    shelf of what continent?
  - Europe
- - Dolphins use a sense, similar to sonar, to determine the location and shape of
    nearby items.
  - Echolocation
- - What is a computer?
